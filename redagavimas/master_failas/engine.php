...
$problem2 = '<img src="./problem2.jpg">';
    ...
    switch(1){
      ...
      case (!empty($_POST['file_name']) && file_exists(__DIR__ . './tekstas/'.$_POST['file_name'].'.txt') ):
        //jeigu rado txt
          ...
          <textarea type="text" name="message" style="width:'.$dydis.'; height:200px;" >'.$from_file.'</textarea>
          <br>
  ...
  if (!empty($_POST['button']) && !empty($_POST['message']) && !empty($_POST['file_name']) ) {
    ...
    <textarea type="text" name="message" style="width:'.$dydis.'; height:200px;" >'.$from_file.'</textarea><br>
    <input type="submit" name="button" value="Įrašyti">
...
if( isset($_GET) && empty($_POST) && !empty($_GET)){
  switch (1) {
    //Jei TXT atvaizduoja
  ...
  <tr>
    <td>
      <form action="" method = "post">
        Nuskaitykite tekstinį dokumentą <br/> iš katalogo "tekstas": <br/><br/>
          <input  type="text" name="file_name" value="" pattern="[a-zA-Z0-9]{3,}" title="Pavadnimas bent iš trijų raidžių ir skaičių.">
          <br><br/>
    ...
    <td> 
      <form action="" method = "post">
          ...
          <input  type="text" name="new_name" value="" pattern="[a-zA-Z0-9]{3,}" title="Pavadnimas bent iš trijų raidžių ir skaičių.">
          <br><br/>
